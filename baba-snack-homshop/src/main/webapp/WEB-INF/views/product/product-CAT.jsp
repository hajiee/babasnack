			...
			<section>
				...
				<div class="mproduct_area">
					<ul class="product-grid">
						<c:forEach items="${products}" var="catProduct">
								<li>
									<div class="product">
										...
										<div class="product-info">
											<p class="product-name">${catProduct.productName}(${catProduct.productSize}g)</p>
											<p class="product-price">${catProduct.productPrice}원</p>
											<p class="product-Stock">재고:${catProduct.productStock}</p>
											<p class="product-Category">
												<a href="/product?category=${catProduct.category}">${catProduct.category}</a>
											</p>
										</div>
									</div>
								</li>
